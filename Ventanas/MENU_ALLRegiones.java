 ...
 * @author ignac
 */
public class MENU_ALLRegiones extends javax.swing.JFrame {

    /**
     * Creates new form MENU_ALLRegiones
     */
    public MENU_ALLRegiones() throws Exception {
        initComponents();
        this.setLocationRelativeTo(null);
        MostrarDatos_Regiones();
        
    }
    
    public void MostrarDatos_Regiones() throws Exception{
    ...
    private void initComponents() {
        ...
        TablaRegiones.setEnabled(false);
        jScrollPane1.setViewportView(TablaRegiones);

        ATRAS.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        ATRAS.setText("ATRÁS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MENU_ALLRegiones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new MENU_ALLRegiones().setVisible(true);
            } catch (Exception ex) {
                Logger.getLogger(MENU_ALLRegiones.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
